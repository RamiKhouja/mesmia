...
export default function Services({auth, categories, services, eventCategories}) {
  ...
  return (
    ...
    <ServiceModal open={modalOpen} setOpen={setModalOpen} user={auth?.user} id={selectedId} />
    </ClientLayout>
  )
}
